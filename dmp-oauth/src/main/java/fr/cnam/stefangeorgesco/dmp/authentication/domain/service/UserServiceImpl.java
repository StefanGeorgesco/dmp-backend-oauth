...
public class UserServiceImpl implements UserService {
	...
	public UserServiceImpl(KeycloakService keycloakService, FileDAO fileDAO, ModelMapper commonModelMapper, BCryptPasswordEncoder bCryptPasswordEncoder) {
	 ...
	 * avec le même identifiant ou le même nom d'utilisateur n'existe pas, qu'un
